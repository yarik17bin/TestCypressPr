import { UIPlugin } from '@TestCypressPr/core'
import { Provider } from '@TestCypressPr/companion-client'
import { ProviderViews } from '@TestCypressPr/provider-views'
...
export default class Box extends UIPlugin {
  ...
  constructor (TestCypressPr, opts) {
    super(TestCypressPr, opts)
    this.id = this.opts.id || 'Box'
    Provider.initPlugin(this, opts)
    this.title = this.opts.title || 'Box'
    this.icon = () => (
      <svg className="TestCypressPr-DashboardTab-iconBox" aria-hidden="true" focusable="false" width="32" height="32" viewBox="0 0 32 32">
    ...
    this.provider = new Provider(TestCypressPr, {
